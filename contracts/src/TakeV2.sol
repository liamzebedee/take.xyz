...
contract Take {
    ...
    // Mint function.
    /// @param take the text of the take
    /// @param subs the substitutions for any variables within the take, in-order.
    function mint(string memory take, string[] calldata subs) public {
