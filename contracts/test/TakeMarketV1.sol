...
contract TakeMarketV1Test is Test {
    ...
    function testNumberIs42() public {
        ...
        // Test factory.
        uint256 takeId = 1;
        TakeMarketSharesV1 takeShares = TakeMarketSharesV1(address(takeMarketV1.getOrCreateTakeSharesContract(takeId)));
        assertTrue(address(takeMarketV1.getTakeSharesContract(takeId)) != address(0));
        assertTrue(takeMarketV1._initialized());
        assertTrue(takeShares._initialized());

        // Deposit.
        // uint256 takeId = 1;
        uint deposit = 99 * 1e18;
        takeMarketV1.deposit(takeId, deposit);
