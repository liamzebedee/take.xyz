...
export const TakeV3DeploymentBlock = 36942472
...
// export const TAKE_BASE_URL = "http://localhost:3000"
export const TAKE_OPENGRAPH_SERVICE_BASE_URL = `http://15.165.74.200:3000`
// export const TAKE_API_BASE_URL = "http://localhost:3000/api/v1"
export const TAKE_API_BASE_URL = `${TAKE_BASE_URL}/api/v1`
// export const TAKE_API_BASE_URL = "http://15.165.74.200"
