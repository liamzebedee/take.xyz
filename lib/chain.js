...
export async function fetchTake2({ takeItContractV1, takeId, provider, fetchRefs }) {
...
export async function fetchTakesBatch({ takeIds, takeItContractV1, takeId, provider }) {
    const { address } = takeItContractV1
    const abi = TakeABI
