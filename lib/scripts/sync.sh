...
cat ../contracts/out/TakeMarketV1.sol/TakeMarketV1.json                     | jq .abi > ./abis/TakeMarketV1.json
cat ../contracts/out/TakeMarketSharesV1.sol/TakeMarketSharesV1.json         | jq .abi > ./abis/TakeMarketSharesV1.json